  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative overflow-hidden">
        ...
        {/* Hero section */}
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48 relative overflow-hidden">
          <div className="absolute -top-8 left-0 opacity-30">
            <img src="/uploads/logo-outline.png" />
          </div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            <div className="sm:max-w-lg">
              <h1
                className={`text-4xl text-gray-900 sm:text-6xl ${theme.text.headers}`}
              >
                We serve
              </h1>
              <h1
                className={`text-4xl text-gray-900 text-gold-400 sm:text-8xl ${theme.text.headers}`}
              >
                Tennis
              </h1>
            </div>
            <div>
              <div className="mt-10">
                ...
                <ButtonLink variant="secondary" href="/racquets">
                  Shop Collection
                </ButtonLink>
              </div>
            </div>
        ...
        <section aria-labelledby="category-heading" className="bg-gray-50">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-baseline sm:justify-between">
              <h2
                id="category-heading"
                className={`text-2xl text-gray-900 ${theme.text.headers}`}
              >
                Shop by Category
              </h2>
              <a
                href="#"
                className="hidden text-sm font-semibold text-yellow-400 hover:text-black sm:block"
              >
        ...
        <section aria-labelledby="cause-heading">
          <div className="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
            ...
            <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center">
              <h2
                className={`text-3xl text-gold-400 font-extrabold tracking-tight text-yellow-400 sm:text-6xl ${theme.text.headers}`}
              >
                Vitas
              </h2>
              <h2
                className={`mt-4 text-3xl font-thin tracking-wider text-white sm:text-4xl ${theme.text.headers}`}
              >
                The new generation of racquets
              </h2>
              <div className="pt-8">
                <ButtonLink variant="primary" href="/vitas">
                  Read more
                </ButtonLink>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-baseline sm:justify-between">
              <h2
                ...
                className={`text-2xl font-extrabold tracking-tight text-gray-900 ${theme.text.headers}`}
              >
                Our Favorites
              </h2>
              <a
